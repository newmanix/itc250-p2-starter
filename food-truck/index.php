...
//Here's where the pizzas are!
include 'includes/pizza-array.php';
/*
//UNCOMMENT TO SEE PIZZAS!
dumpDie($pizzas);
*/
...
{# shows form so user can enter their name.  Initial scenario
    ...
    global $pizzas; // allows us to see the pizza data
    echo '<h3>Pizzas!</h3>';
    ...
    */
    foreach($pizzas as $pizza)
    {
        //dumpDie($pizza);
        echo '
        <p><input type="checkbox" name="Pizza" value="' . $pizza->Type . '" /> 
        ' . $pizza->Size . ' ' . $pizza->Type . ' Pizza for only ' . $pizza->Price . '</p>
        ';
    }
